...
{ config, lib, modulesPath, ... }:
{
  ...
  boot.initrd.availableKernelModules = [ "nvme" "xhci_pci" "thunderbolt" "usb_storage" "sd_mod" "usbhid" "rtsx_pci_sdmmc" ];
  ...
  fileSystems."/" = {
    ...
    fsType = "btrfs";
    options = [ "subvol=@" "noatime" "compress=zstd:1" "commit=120" ];
  };

  fileSystems."/home" = {
    device = "/dev/disk/by-uuid/1198bc8f-1186-44a5-aed4-e9a0bbb80ab6";
    fsType = "btrfs";
    options = [ "subvol=@home" "noatime" "compress=zstd:1" "commit=120" ];
  };

  fileSystems."/nix" = {
    device = "/dev/disk/by-uuid/1198bc8f-1186-44a5-aed4-e9a0bbb80ab6";
    fsType = "btrfs";
    options = [ "subvol=@nix" "noatime" "compress=zstd:1" "commit=120" ];
  };

  fileSystems."/var/log" = {
    device = "/dev/disk/by-uuid/1198bc8f-1186-44a5-aed4-e9a0bbb80ab6";
    fsType = "btrfs";
    options = [ "subvol=@log" "noatime" "compress=zstd:1" "commit=120" ];
  };
